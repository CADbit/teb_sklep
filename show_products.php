...
?>
                ...
                <div class="col-sm-4">
                    ...
                    if (isset($_SESSION['shop']) && count($_SESSION['shop']) != 0) {
                        echo "<i class=\"fas fa-cart-arrow-down\" style='font-size: xx-large;'></i>";
                        echo "(".count($_SESSION['shop']).")";
                    } else {
                        echo "<i class=\"fas fa-shopping-cart\" style='font-size: xx-large;'></i>";
                    }
                    ?>
                    <a href="logout.php" class="btn btn-danger float-right">Wyloguj</a>
                </div>
            </div>
            ...
            <table class="table">
                ...
                for ($i = 0; $i < count($products); $i++) {
                    ...
                    <td><a href='?add=".$products[$i][0]."'><i class=\"fas fa-cart-plus\" style='font-size: xx-large;'></i></a></td>
                </tr>";
                }
                echo($tr);
                ?>
